...
#ifndef CAR_NANO_ROUTING_ENTITY_H
#define CAR_NANO_ROUTING_ENTITY_H
...
namespace ns3 {
	 ...
	 *
	 */
	class CarNanoRoutingEntity: public NanoRoutingEntity {
		public:
			static TypeId GetTypeId(void);

			CarNanoRoutingEntity(void);
			virtual ~CarNanoRoutingEntity(void);
...
#endif /* CAR_NANO_ROUTING_ENTITY_H */
