...
#ifndef LOCATION_NANO_ROUTING_ENTITY_H
#define LOCATION_NANO_ROUTING_ENTITY_H
...
namespace ns3 {
	 ...
	 *
	 * This class implements the Location Routing protocol, as described in
	 *
	 ...
	 *
	 */
	class LocationNanoRoutingEntity: public NanoRoutingEntity {
		public:
			static TypeId GetTypeId(void);

			LocationNanoRoutingEntity(void);
			virtual ~LocationNanoRoutingEntity(void);
		...
		//Selective location implementation
		public:
...
#endif /* LOCATION_NANO_ROUTING_ENTITY_H */
