...
#ifndef TRADITIONAL_NANO_ROUTING_ENTITY_H
#define TRADITIONAL_NANO_ROUTING_ENTITY_H
...
namespace ns3 {
	 ...
	 *
	 * This class implements the Traditional Routing protocol, as described in
	 *
	 ...
	 *
	 */
	class TraditionalNanoRoutingEntity: public NanoRoutingEntity {
		public:
			static TypeId GetTypeId(void);

			TraditionalNanoRoutingEntity(void);
			virtual ~TraditionalNanoRoutingEntity(void);
		...
		//Selective traditional implementation
		public:
...
#endif /* TRADITIONAL_NANO_ROUTING_ENTITY_H */
