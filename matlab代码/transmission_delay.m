...
for i = 1:filesNum
    for j=1:nodeNum
        file2 = ['D:\professional_install\matlab\bin\project_files\conflict_zhao\log', num2str(i),'\location_Rx', num2str(j), '.log'];
        fid2 = fopen(file2);
...
for i = 1:filesNum
    for j=1:nodeNum
        file3 = ['D:\professional_install\matlab\bin\project_files\conflict_zhao\log', num2str(i),'\car_Rx', num2str(j), '.log'];
        fid3 = fopen(file3);
